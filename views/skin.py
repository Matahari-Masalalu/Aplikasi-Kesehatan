...
def classify_image(image, interpreter, class_names, img_size=(450, 450)):
    ...
    data = np.expand_dims(image_array, axis=0).astype(np.float32)  # Expand dimensions for the model input
...
if st.session_state.page == "info":
    ...
    if uploaded_file is not None:
        ...
        # Classify the image
        class_name, confidence_score = classify_image(image, interpreter, class_names)
